...
function Ingest() {
  ...
  // 🔹 Trasformazione logsData in headers e details
  ...
  useEffect(() => {
    ...
    // Separiamo headers (esecuzioni principali) dai dettagli (flussi)
    const headersMap = {};
    const detailsArr = [];

    logsData.forEach((log) => {
      // log.logKey = chiave esecuzione principale
    ...
    switch (activeTab) {
      ...
      case "logs":
        ...
        return (
          <LogsTabContent
            logsData={logsData}
            historyData={historyData} // qui metti i dettagli dei flussi
